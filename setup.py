...
exec(open('monsturmapper/version.py').read())

setup(
    name="monsturmapper",
    version=__version__,
    author="Cameron Bodine, Stephanie Popp",
    ...
    project_urls={
        "Issues": "https://github.com/PINGEcosystem/MonSturMapper/issues",
        "GitHub":"https://github.com/PINGEcosystem/MonSturMapper",
